//
// tistory-markdown.js -- A Markdown coverter for Tistory.
//
// Author : Su Yeol Jeon (http://xoul.kr)
//

function markdown(){var a=new Showdown.converter;var b=document.getElementsByClassName("markdown");for(var c=b.length-1;c>=0;c--){var d=a.makeHtml(b[c].innerText);var e=document.createElement("div");e.innerHTML=d;b[c].parentNode.insertBefore(e,b[c]);b[c].parentNode.removeChild(b[c])}}
